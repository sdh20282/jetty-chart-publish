...
/* eslint-disable complexity */const NormalMap = _ref => {
  ...
  const [firstY, setFirstY] = (0, _react.useState)();
  const [firstH, setFirstHeight] = (0, _react.useState)();
  const [targetColor, setTargetColor] = (0, _react.useState)("");
  const [chartOn, setChartOn] = (0, _react.useState)(false);
  const [chartDataSetting, setChartDataSetting] = (0, _react.useState)();
  const [innerChartName, setInnerChartName] = (0, _react.useState)("");
  const [tooltipChartCheck, setTooltipChartCheck] = (0, _react.useState)();
  ...
  (0, _react.useEffect)(() => {
    ...
    if (useChart && chartData) {
      ...
      function zoomin(e) {
        ...
        let targetViewBox = onZoom ? "".concat(-1680, " ").concat(-1590, " ", 2620, " ", 2650) : "0 0 1048 1064";
        animateViewBox(targetViewBox, 350); // << 여기서 두번째 숫자가 duration 애니메이션 지연시간
        setScale(newScale);
      }
      mapSvg.addEventListener("click", zoomin);
  ...
  return (
    ...
    (0, _jsxRuntime.jsx)("div", {
      className: _normalMapModule.default.MAPCHARTMAIN,
      style: {
      ...
      children: /*#__PURE__*/(0, _jsxRuntime.jsxs)("svg", {
        ...
        children: [/*#__PURE__*/(0, _jsxRuntime.jsxs)("g", {
          ...
          ref: tooltipRef,
          id: "tooltipBox",
          children: useTooltipChart && scale != 1 ? /*#__PURE__*/(0, _jsxRuntime.jsx)("foreignObject", {
            id: "foreingObject",
            x: "0",
            y: "0",
            width: 545 / scale,
            ...
            children: /*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
              ...
              style: tooltipOn ? {
                ...
                maxWidth: "".concat(545 / scale, "px"),
                // height: "100%",
                minHeight: "".concat(150 / scale, "px"),
                maxHeight: "".concat(545 / scale, "px"),
                display: "flex",
              ...
              children: [/*#__PURE__*/(0, _jsxRuntime.jsx)("p", {
                ...
                children: tooltipCity
              }), tooltipChartCheck != 0 ? /*#__PURE__*/(0, _jsxRuntime.jsx)(_bars.NormalBar, {
        ...
        }), useValueLabel && scale === 1 ? /*#__PURE__*/(0, _jsxRuntime.jsx)("text", {
          ...
          textAnchor: "end",
          children: valueLabel
        }) : "", chartOn && scale == 0.4 && chartDataSetting ? /*#__PURE__*/(0, _jsxRuntime.jsx)(_jsxRuntime.Fragment, {
          children: /*#__PURE__*/(0, _jsxRuntime.jsx)("foreignObject", {
            x: "-1360",
            y: "-1440",
            width: innernormalSettings.width + 300,
            height: innernormalSettings.height + 300,
            children: /*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
              style: {
              ...
              children: [/*#__PURE__*/(0, _jsxRuntime.jsx)("p", {
                style: {
                  fontSize: "".concat(innerChartTitleFontSize, "px"),
                  margin: "0",
                  marginBottom: "50px",
                  fontWeight: "".concat(innerChartTitleFontWeight)
                },
                children: chartDataSetting != 0 ? /*#__PURE__*/(0, _jsxRuntime.jsxs)(_jsxRuntime.Fragment, {
                  children: [innerChartName, " ", innerChartText]
                }) : "차트 데이터가 없습니다."
              }), /*#__PURE__*/(0, _jsxRuntime.jsx)(_bars.NormalBar, {
