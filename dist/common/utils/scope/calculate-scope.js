...
exports.getUserScope = exports.getAutoScope = void 0;
...
const getAutoScope = _ref2 => {
  ...
  return {
    scope: scopeResult,
    maxScope: nowMaxScope,
    minScope: nowMinScope
  };
};
exports.getAutoScope = getAutoScope;
const getUserScope = _ref3 => {
  let {
    maxScope,
    minScope
  } = _ref3;
  ...
  const bottomMarginRatio = scopeResult[scopeResult.length - 1] === minScope ? 0 : (scopeResult[scopeResult.length - 2] - minScope) / (maxScope - minScope);
  return {
    scope: scopeResult.slice(maxScope === scopeResult[0] ? 0 : 1, minScope === scopeResult[scopeResult.length - 1] ? scopeResult.length : scopeResult.length - 1),
