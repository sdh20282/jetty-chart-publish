    ...
    if (setting === "animationSettings") {
      Object.keys(stackedBarSetting[setting]).forEach(animation => {
        ...
        Object.keys(stackedBarSetting[setting][animation]).forEach(detail => {
          ...
          (_result$setting$anima2 = (_result$setting$anima = result[setting][animation])[detail]) !== null && _result$setting$anima2 !== void 0 ? _result$setting$anima2 : _result$setting$anima[detail] = stackedBarSetting[setting][animation][detail];
        });
      });
    } else {
      Object.keys(stackedBarSetting[setting]).forEach(detail => {
        var _result$setting3, _result$setting3$deta;
        (_result$setting3$deta = (_result$setting3 = result[setting])[detail]) !== null && _result$setting3$deta !== void 0 ? _result$setting3$deta : _result$setting3[detail] = stackedBarSetting[setting][detail];
      });
    }
  });
...
exports.checkStackedBar = checkStackedBar;